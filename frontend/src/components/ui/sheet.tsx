...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 text-muted opacity-70 transition-opacity hover:bg-accent/10 hover:opacity-100 focus:outline-none">
        <X className="h-4 w-4" />
